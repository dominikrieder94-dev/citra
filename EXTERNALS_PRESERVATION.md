...
- `externals/soundtouch` has now been normalized back to clean upstream commit `9ef8458d8561d9471dd20e9619e3be4cfe564796`. The preserved local tree-replacement snapshot remains recoverable in nested history as `26ea8b97eeb87427e5973cda012bd9074536f576`, but the active Android integration now lives explicitly in the superproject via `externals/CMakeLists.txt`.
- `externals/libressl` has now been normalized back to clean fork head `88b8e41b71099fabc57813bc06d8bc1aba050a19`. The preserved local tree-replacement snapshot remains recoverable in nested history as `ab327f02cd682101dd3af930b99e6ca40602e1ec`.
- `externals/boost` remains intentionally pinned to preserved snapshot `4cc38a77d7c5bfd0c73e3ceef8ef54e64387a2a2`. Rewinding it to old clean commit `36603a1e665e849d29b1735a12c0a51284a10dd0` breaks Android compilation because old Boost still uses `std::unary_function` in `boost/container_hash/hash.hpp`.
- `externals/nihstro` is now minimized to local compatibility commit `b2291a63a6bdbb095b68dcffde6be3c73887cf17` on top of clean upstream `f4d8659f85874de9044d197b1d4a7f8340de1d4b`. Rewinding to `fd69de1a1b960ec296cc67d32257b0f9e2d89ac6` still breaks Android compilation under current libc++ because the old code specializes `std::make_unsigned`.
...
- `externals/inih/inih` has been repaired back to the clean historical gitlink `2023872dfffb38b6a98f2c45a0eb25652aaea91f`. The broken empty-tree local commit `319893ccbe95662983177b589a6cb76f90cc8c65` remains in nested history only as an audit artifact, not as the active baseline.
- `externals/nihstro` must remain on its preserved snapshot `c9af0af155514b5c12a6f2d9e2b10fb98ec66750` for now. Rewinding it to `fd69de1a1b960ec296cc67d32257b0f9e2d89ac6` breaks Android compilation under the current NDK/libc++ because the old code specializes `std::make_unsigned`.
