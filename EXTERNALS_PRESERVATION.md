...
- `externals/nihstro` remains intentionally pinned to preserved snapshot `c9af0af155514b5c12a6f2d9e2b10fb98ec66750`. Rewinding it to `fd69de1a1b960ec296cc67d32257b0f9e2d89ac6` breaks Android compilation under current libc++ because the old code specializes `std::make_unsigned`.
