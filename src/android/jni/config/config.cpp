...
void SaveDefault() {
    ...
    s_layer.Set(USE_FASTMEM, USE_FASTMEM.default_value);
    ...
    s_layer.Set(HYBRID_SIDE_COLUMN_LEFT, HYBRID_SIDE_COLUMN_LEFT.default_value);
    s_layer.Set(LANDSCAPE_HYBRID_SIDE_COLUMN_LEFT,
                LANDSCAPE_HYBRID_SIDE_COLUMN_LEFT.default_value);
    s_layer.Set(HYBRID_SECONDARY_TOP, HYBRID_SECONDARY_TOP.default_value);
    s_layer.Set(LANDSCAPE_HYBRID_SECONDARY_TOP, LANDSCAPE_HYBRID_SECONDARY_TOP.default_value);
