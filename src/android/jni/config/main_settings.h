...
extern const ConfigInfo<bool> LANDSCAPE_LARGE_SCREEN_SECONDARY_TOP;
extern const ConfigInfo<bool> HYBRID_SIDE_COLUMN_LEFT;
...
extern const ConfigInfo<u16> LANDSCAPE_LAYOUT_MARGIN_TOP;
extern const ConfigInfo<u16> LAYOUT_MARGIN_RIGHT;
